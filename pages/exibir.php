...
<head lang="pt-BR">
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='../styles/exibir.css'>
...
<body>
    ...
    <div class="conteudo">
        ...
        $code = "SELECT * FROM mangas LIMIT $inicio, $quantidade";
        ...
        <section>
            ...
            <div class="Div-Icon">
                <!-- Botão para editar -->
                <a class="icon icon1" href="editar.php?page=<?php echo$page_atual?>&id=<?php echo $row['id']?>&foto=<?php echo $row['arquivo']?>&titulo=<?php echo $row['nome']?>&autor=<?php echo $row['autor']?>&volume=<?php echo $row['volume']?>&capitulo=<?php echo $row['capitulo']?>&status=<?php echo $row['statush']?>&genero=<?php echo $row['genero']?>"></a>
                <!-- Botão para apagar -->
                <a class="icon icon2" href="apagar.php?page=<?php echo$page_atual?>&id=<?php echo $row['id']?>&nome=<?php echo $row['nome']?>"></a>
